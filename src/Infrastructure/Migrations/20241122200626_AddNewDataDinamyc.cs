...
{
    /// <inheritdoc />
    public partial class AddNewDataDinamyc : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Prom",
                keyColumn: "Id",
                keyValue: new Guid("594008d6-0087-4481-8de7-2624ef02cb06"));

            migrationBuilder.AddColumn<int>(
                name: "CountNigthsHotel",
                table: "PromDinamyc",
                type: "integer",
                nullable: false,
                defaultValue: 0);
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Prom",
                keyColumn: "Id",
                keyValue: new Guid("4e92123e-9bd8-4ea2-836c-9f9b11acb638"));
